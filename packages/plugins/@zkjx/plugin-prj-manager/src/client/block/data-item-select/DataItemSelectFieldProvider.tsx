...
export const DataItemSelectBlockContext = createContext<any>({});
const useDataSelectBlockRecord = () => {
  const { record } = useDataItemSelectBlockContext();
  return record;
};
export const useDataItemSelectBlockContext = () => {
  return useContext(DataItemSelectBlockContext);
};

export const useDataItemSelectFormSelectBlockProps = () => {
  const ctx = useDataItemSelectBlockContext();
  return {
    form: ctx?.form,
    layout: 'inline',
    size: 'large',
...
export const useDataItemSelectFormSelectOptionsProps = (props) => {
  const { resource, action, params, service, record } = useDataItemSelectBlockContext();
...
const InternalDataSelectFieldProvider = (props) => {
  ...
  return (
    <DataItemSelectBlockContext.Provider
      value={{
        ...props,
        field,
        form,
...
export const DataItemSelectFieldProvider = (props) => {
  //首次加载使用 id
...
DataItemSelectFieldProvider.displayName = 'DataItemSelectFieldProvider';
