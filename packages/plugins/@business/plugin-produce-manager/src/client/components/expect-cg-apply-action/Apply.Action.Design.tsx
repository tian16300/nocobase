...
import { GeneralSchemaDesigner, SchemaSettingsActionScopeBind, SchemaSettingsButtonEditor, SchemaSettingsDivider, SchemaSettingsModalItem, SchemaSettingsRemove, useDesignable } from '@nocobase/client';
import React from 'react';
import { useTranslation } from 'react-i18next';


export const ApplyActionDesign = (props) => {
