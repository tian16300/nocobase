import { SchemaInitializerItem, createTableBlockSchema, useCollection, useCollectionManager, useRecordCollectionDataSourceItems, useSchemaInitializer, useSchemaInitializerItem, useSchemaTemplateManager } from "@nocobase/client";
import React from "react";
import { FormOutlined } from '@ant-design/icons';
import { uid } from "@nocobase/utils";
export const RecordAssociationGanttBlockInitializer = () => {
    ...
    return (
      <SchemaInitializerItem
        ...
        items={useRecordCollectionDataSourceItems('PrjWorkPlan', itemConfig, field.target, resource)}
      />
    );
};
