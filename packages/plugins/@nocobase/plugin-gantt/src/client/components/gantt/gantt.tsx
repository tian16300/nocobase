...
import { ActionContextProvider, CollectionProvider, FormProvider, RecordProvider, WithoutTableFieldResource, useAPIClient, useBlockRequestContext, useCollection, useCollectionManager, useCurrentAppInfo, useDesignable, useProps, useTableBlockContext, useToken } from '@nocobase/client';
...
const saveTaskResource = async (task, params, resource, fieldNames, service, t) => {
...
const debounceHandleTaskChange = debounce(async (task: Task, resource, fieldNames, service, t) => {
  ...
  await saveTaskResource(task,param,resource, fieldNames, service, t);
}, 300);
