    ...
    fields: [
      ...
      },
      {
        ...
        uiSchema: {
          ...
          'x-read-pretty': true,
          enum: [
            { label: '{{t("新增")}}', value: 'create', color: 'lime' },
            { label: '{{t("修改")}}', value: 'update', color: 'gold' },
            { label: '{{t("删除")}}', value: 'destroy', color: 'magenta' },
            { label: '{{t("作废")}}', value: 'deActive', color: 'magenta' },
            { label: '{{t("恢复")}}', value: 'restore', color: 'lime' },
          ],
        },
      },
      {
